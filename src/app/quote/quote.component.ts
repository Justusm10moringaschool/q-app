...
export class QuoteComponent implements OnInit {
  quotes:Quote[] =[
    ...
    new Quote(4,'The future of mobile is the future of online. It is how people access online content now.', 'Robert Einsten', 'Quoted by Phil Nickinson, Editor of Android Central', 0, 0, new Date(2019,11,2)),
