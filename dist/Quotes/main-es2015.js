...
let HighlighteQuoteDirective = class HighlighteQuoteDirective {
    constructor(elem) {
        this.elem = elem;
        this.elem.nativeElement.style.backgroundColor = 'yellow';
    }
};
HighlighteQuoteDirective.ctorParameters = () => [
...
class Quote {
    constructor(id, quote, publisher, author, upvote, downvote, myDate) {
        this.id = id;
        this.quote = quote;
...
let TimeCountPipe = class TimeCountPipe {
